...
public:
  ...
  void parameter_bound(arma::Mat<double>& mu_bnd)
  {
    ...
    switch (param_mode) {
    case 0:
      mu_bnd.row(0) = sig_bnd;
      mu_bnd.row(1) = kap_bnd;
      mu_bnd.row(2) = cw3_bnd;
      break;
    case 1:
      mu_bnd.row(0) = sig_bnd;
      mu_bnd.row(1) = kap_bnd;
      mu_bnd.row(2) = cw3_bnd;
      mu_bnd.row(3) = cw2_bnd;
      break;
    case 2:
      mu_bnd.row(0) = kap_bnd;
      break;
    case 3:
      mu_bnd.row(0) = kap_bnd;
      mu_bnd.row(1) = fs_chi_log_bnd;
      break;
    case 4:
      mu_bnd.row(0) = alpha_delta_bnd;
      break;
    case 5:
      mu_bnd.row(0) = alpha_delta_bnd;
      mu_bnd.row(1) = M_delta_bnd;
      break;    
    default:
      Error("unknown mode");      
    }
...
public:
  ...
  void setup_eqp() {
    ...
    eqn.generate_structured_Xi(n1d,Xi_train);
